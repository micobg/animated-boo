...
public class TermsMysqlPersister {
    ...
    /**
     * Load best suggestion for an incorrect word (by its terms).
     *
     * @param terms terms generated by deletions from an incorrect word
     *
     * @return best suggestions or null if there is no suggestion
     */
    public String loadSuggestion(Set<String> terms) {
        ...
        try  {
            ...
            while(resultSet.next()) {
                suggestion = resultSet.getString("term");
            }
        } catch (SQLException ex) {
